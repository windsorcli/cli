...
Examples:
  ...
  windsor mirror`,
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		report, err := comp.Mirror(mirror.Options{HostPort: mirrorPort, Concurrency: mirrorConcurrency})
		if err != nil {
...
func init() {
	mirrorCmd.Flags().IntVar(&mirrorPort, "port", 5000, "Host port to expose the local registry on")
