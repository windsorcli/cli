...
func setupContainer(mockCLIConfigHandler, mockProjectConfigHandler config.ConfigHandler, mockShell *shell.MockShell, mockTerraformHelper helpers.Helper) di.ContainerInterface {
...
func TestPreRunLoadConfig(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		setupContainer(mockCLIConfigHandler, mockProjectConfigHandler, mockShell, nil)
