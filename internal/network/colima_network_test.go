...
func TestColimaNetworkManager_ConfigureGuest(t *testing.T) {
	...
	t.Run("ResolveShellError", func(t *testing.T) {
		// Create a mock injector that does not register the secure shell
		injector := di.NewInjector()
		injector.Register("secureShell", shell.NewMockShell(injector))
