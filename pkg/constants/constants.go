...
const (
	...
	// Hook URL is generated by:
	// echo -n "${token}${name}${namespace}" | openssl dgst -sha256 | awk '{print $2}'
	// development values:
	// - token: "abcdef123456"
	// - name: webhook-receiver
	// - namespace: system-gitops
	DEFAULT_GIT_LIVE_RELOAD_WEBHOOK_URL = "http://flux-webhook.test:8080/hook/216e5ada00ea684e0f694bcccf491d204baba6840e615c4f065ac085552af878"
)
