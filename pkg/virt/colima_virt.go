...
func (v *ColimaVirt) WriteConfig() error {
	...
	colimaConfig := colimaConfig.Config{
		...
		Runtime:              "docker",
		Hostname:             hostname,
		Kubernetes:           colimaConfig.Kubernetes{Enabled: false},
		ActivateRuntime:      new(bool),
		Network:              colimaConfig.Network{Address: true, DNSResolvers: []net.IP{}, DNSHosts: map[string]string{}, HostAddresses: true},
		ForwardAgent:         false,
	...
	*colimaConfig.ActivateRuntime = true
	*colimaConfig.ActivateRuntime = true
